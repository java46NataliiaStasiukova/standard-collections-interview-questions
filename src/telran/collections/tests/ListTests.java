...
class ListTests {
	...
	List<Integer> list = Arrays.asList(numbers);//immutable
	List<Integer> listMutable = new ArrayList<>(list);//mutable
	@BeforeEach
	void setUp() {
	...
	void listViewTest() {
		...
		subList.remove(4);
		assertEquals(expectedAfterRemove, listMutable.toArray(new Integer[0]));
		subList.add(4, 7);
		assertEquals(numbers, listMutable.toArray(new Integer[0]));
		subList.clear();
	...
	@Test
	void queueTest() {
//		StackInt<Integer> stack = new StackInt<>();
//		stack.add(1);
//		stack.add(2);
//		stack.add(3);
//		stack.add(1, 10);
